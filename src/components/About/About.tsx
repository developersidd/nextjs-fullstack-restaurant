...
const AboutComp = () => {
    return (
        <div className="relative">
            ...
            <Image
                src={leafRight}
                className="absolute hidden lg:block lg:w-[200px] lg:h-[200px] 2xl:w-[300px] 2xl:h-[340px] -top-16 md:-top-[18%]  z-[99] left-0"
                alt="leaf"
            />
            {/* right side image */}
            <Image
                src={leafLeft}
                className="absolute hidden lg:block lg:w-[200px] lg:h-[200px] 2xl:w-[300px] 2xl:h-[340px] -top-16 md:top-[-18%]  z-[99] right-0"
                alt="restaurant"
            />
            ...
            <div className='lg:container mx-auto px-5 md:px-8 py-10 md:py-14 lg:py-20 md:flex items-center justify-start gap-10 max-md:space-y-10'>
                ...
                <div className="w-full md:w-[50%]">
                    <div className="space-y-5 relative">
                        ...
                        <h2 className="text-sandy-brown  font-bold text-xl md:text-3xl lg:text-4xl xl:text-5xl"> {("The Wilma is a premium taste that yearns to be savored, ground beef between your teeth").split(" ").map((text, ind) => (<p className="inline-block mr-1 md:mr-2" data-aos="fade-left" key={ind}> {text} </p>))}
                        </h2>
