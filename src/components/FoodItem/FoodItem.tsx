    ...
    return (
        <div className='p-3 text-center z-[999]'>
            <Link href={`/foods/${_id}`} className='inline-block  rounded-full group/image relative w-[250px] h-[250px] mb-3'>
                ...
                <div className='transition-opacity	duration-500 opacity-0 group-hover/image:opacity-100 absolute top-0 left-0 right-0 flex items-center justify-center gap-4 p-7 bg-primary-yellow/80 rounded-full w-ful h-full'>
            ...
            <div className='space-y-3 text-center text-gray-300'>
                ...
                <p className='text-xl md:text-2xl font-bold'> <span className="text-primary-yellow">$</span> {price} </p>
            </div>
        </div>
    )
}
