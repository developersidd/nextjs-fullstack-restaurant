...
const HighlightedMenuItem = ({ title, des, price, tag, ...props }: { title: string, des: string, price: string, tag: string }) => {
    return (
        <div {...props} className="border border-primary-yellow mb-4 rounded relative top-0 right-0 lg:right-4 lg:w-[107%]">
            <h3 className="p-4 bg-primary-yellow text-white font-bold text-lg lg:text-xl tracking-wider"> {tag} </h3>
            <div className="p-4">
