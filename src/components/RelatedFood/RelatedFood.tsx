    ...
    return (
        <div className='py-6 lg:py-8 px-3 lg:px-5 text-center z-[999] bg-[#172125] group/cart max-lg:mb-20  last:mb-0'>
            ...
            <div className='space-y-4 text-center text-gray-300'>
                ...
                <button className="mx-auto transition-colors border-2 border-white hover:border-primary-yellow hover:text-primary-yellow px-3 lg:px-4 py-2 lg:py-[9px] gap-2 flex items-center text-base font-medium"> <ShoppingCartIcon className='w-6 h-6' /> Add To Cart </button>
            </div>
        </div>
    )
}
